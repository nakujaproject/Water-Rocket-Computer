...
const float TAKE_OFF_AGL_DISPLACEMENT = 20;
const float DROGUE_DEPLOYMENT_BELOW_APOGEE_DISPLACEMENT = 5;
const float MAIN_DEPLOYMENT_BELOW_DROGUE_DISPLACEMENT = 5;
